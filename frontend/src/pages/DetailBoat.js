...
import { fetchReviews, setActiveTab } from "../redux/action";
        ...
        <div className="flex flex-col md:flex-row gap-4">
          <div className="md:w-8/12">
            ...
            <div className="flex items-center gap-2 my-5">
              ...
              >
                <span>{currentYacht?.IdCompanys?.address || "Chưa có địa chỉ"}</span>
                <span className="light:text-teal-400 dark:text-teal-600 underline pl-2">Xem bản đồ và lịch trình</span>
              </Link>
            </div>
            <Image src="/images/border.jpg" className="my-4" />
          </div>
      ...
      <Container className="py-20">
        ...
        <div className="flex flex-col md:flex-row mt-10 gap-6">
          <div className="md:w-8/12">
            ...
            <div id="map" className="mt-16 scroll-mt-44">
            ...
            {/* Đánh giá sao của YACHT */}
            <div id="reviews" className="mt-16 scroll-mt-44" ref={(el) => (sectionRefs.current.reviews = el)}>
