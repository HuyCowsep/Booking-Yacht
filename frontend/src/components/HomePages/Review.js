  ...
  return (
    <Box sx={{ width: "100%", py: 8, px: 2 }}>
      <Box maxWidth={900} mx="auto">
        <Typography fontFamily={"Archivo, sans-serif"} variant="h4" fontWeight={800} mb={2} color="text.primary">
          Đánh giá từ những người đã trải nghiệm
        </Typography>
        <Typography fontFamily={"Archivo, sans-serif"} mb={4} color="text.secondary">
          Những khoảnh khắc đáng nhớ cùng du thuyền, nơi khách hàng đã trải qua kỳ nghỉ tuyệt vời giữa thiên nhiên Hạ
          Long tuyệt mỹ, thưởng thức dịch vụ đẳng cấp và lưu giữ kỷ niệm khó quên cùng người thân yêu.
        </Typography>
        ...
        >
          ...
          <Typography variant="body1" fontFamily={"Archivo, sans-serif"} fontStyle="italic" color="text.secondary">
            “{selected.text}”
          </Typography>
          <Typography mt={2} variant="subtitle1" color="primary" fontWeight={700} fontFamily={"Archivo, sans-serif"}>
            {selected.name} -
          </Typography>
        </Paper>
