        ...
        <Container className="py-20">
          ...
          <Row className="flex">
            ...
            <Col className="w-3/12 pt-10">
              <div className=" mx-auto w-fit  border shadow-lg rounded-xl flex flex-col justify-center items-center bg-white">
                <div className="content py-5 px-6">
                  <p className="title text-xl font-bold text-center text-gray-800">
                    Thông tin du thuyền
                  </p>
                  <hr className="w-full border-t border-gray-300 my-2" />
                  <div className="details space-y-4 pt-4">
                    <div className="item flex gap-6 items-start">
                      <div className="icon-text text-gray-600 flex gap-2 items-center">
                        <FaAnchor size={20} />
                        <p className="font-normal">Hạ Thủy</p>
                      </div>
                    ...
                    <div className="item flex gap-6 items-start">
                      <div className="icon-text text-gray-600 flex gap-2 items-center">
                        <FaBox size={20} />
                        <p className="font-normal">Cabin</p>
                      </div>
                      <p className="text-gray-900 font-medium">46</p>
                    </div>
                    <div className="item flex gap-6 items-start">
                      <div className="icon-text text-gray-600 flex gap-2 items-center">
                        <FaShip size={20} />
                        <p className="font-normal">Thân vỏ</p>
                      </div>
                      <p className="text-gray-900 font-medium">Kim loại</p>
                    </div>
                    <div className="item flex gap-6 items-start">
                      <div className="icon-text text-gray-600 flex gap-2 items-center">
                        <FaLocationDot size={20} />
                        <p className="font-normal">Hành trình</p>
                      </div>
                    ...
                    <div className="item flex gap-6 items-start">
                      <div className="icon-text text-gray-600 flex gap-2 items-center">
                        ...
                        <p className="font-normal">Điều hành</p>
                      </div>
                      <p className="text-gray-900 font-medium">
